...
class CalendarioElimDobleTest {

    private static CalendarioElimDoble calendario;
    ...
    void setUp(){
        ...
        calendario = new CalendarioElimDoble();
    }

    @Test
    @DisplayName("4 Participantes")
    void creacionCalendario4() {
        participantes.setAgrupacionParticipantes(TipoTorneo.Doble_Eliminacion);
    ...
    void creacionCalendario0() {
        ...
        participantes0.setAgrupacionParticipantes(TipoTorneo.Doble_Eliminacion);
    ...
    void creacionCalendario1() {
        ...
        participantes1.setAgrupacionParticipantes(TipoTorneo.Doble_Eliminacion);
    ...
    void actualizarCalendario() {
        Torneo t = new Torneo("asdsa",TipoTorneo.Doble_Eliminacion);
