...
class CalendarioTest {
    ...
    void crearCalendario16() {
        ...
        calendario = new Calendario();
        calendario.setTipoDeCalendario(TipoTorneo.Eliminacion_Directa,2,CantidadParticipantes.Dieciseis,participantes);assertEquals(8, calendario.getCantJornadas());
    }
