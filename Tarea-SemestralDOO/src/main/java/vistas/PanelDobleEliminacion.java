...
public class PanelDobleEliminacion extends JPanel implements PanelTorneo {
    ...
    public PanelDobleEliminacion(){
        ...
        upperPanel.setBounds(0,0,1000,600);
        ...
        upperPanel.add(upperScroll);
        add(upperPanel);

        lowerPanel = new JPanel();
        lowerPanel.setSize(1000,600);
        ...
        lowerPanel.add(lowerScroll);
        add(lowerPanel);

        upperButton = new JButton("Upper");
        upperButton.setBounds(800,540,200,60);
        ...
        lowerButton.setBounds(800,540,200,60);
        ...
        noHayEnfrentamiento.setBounds(400,100,200,50);
            ...
            if(enfrentamientos.size() == 1){
                ...
                if (ronda == 0){
                    for (int i = 0; i < enfrentamientos.size(); i++) {
                        ...
                        panel.setBounds(
                                50,
                                10 + (i - mitad) * 70 * (int) Math.pow(2, ronda),
                                80, 60);
                        upperView.add(panel);
